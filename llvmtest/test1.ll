...
%struct.Value = type { i32, i32, i32, [128 x i8] }

@.str = private unnamed_addr constant [15 x i8] c"Hello world!!\0A\00", align 1

; Function Attrs: noinline nounwind ssp uwtable
define void @_Z3subv(%struct.Value* noalias sret) #0 {
  %2 = getelementptr inbounds %struct.Value, %struct.Value* %0, i32 0, i32 2
  store i32 3, i32* %2, align 4
  %3 = getelementptr inbounds %struct.Value, %struct.Value* %0, i32 0, i32 1
  store i32 3, i32* %3, align 4
  %4 = getelementptr inbounds %struct.Value, %struct.Value* %0, i32 0, i32 0
...
define i32 @main(i32, i8**) #1 {
  ...
  call void @_Z3subv(%struct.Value* sret %6)
